...
6. **No-Fly Extensions (Anti-Hang Protocol)**: Agents are strictly prohibited from opening, scraping, reading, or following any URLs or links that point directly to large file formats. 
